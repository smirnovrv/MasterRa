...
//		КонецЦикла;
		...
		ОстатокНаКонец = ОбластьНачОстатки.Параметры.СуммаНачальныйОстатокДт + всегоДт - всегоКт;
		ОстатокНаКонецКонтр = ОбластьНачОстатки.Параметры.СуммаНачальныйОстатокДт - всегоКт + всегоДт;
