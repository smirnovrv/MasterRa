...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда 
			Объект.Счет                     = Неопределено; //доп. 14.01.20
	...
	Если Переделка Тогда 
		...
		Элементы.СтраницаДополнительно.ТолькоПросмотр	= Ложь; //изм. 17.01.20
	...
	//Если Объект.Статус = Перечисления.Статусы.Закрыт И РольДоступна("КоммерческийДиректор")=Ложь Тогда   
	...
	Элементы.Номер.ТолькоПросмотр = РольДоступна("Менеджер"); //08.04.21
...
Процедура УстановкаВидимости()
	...
	Элементы.СтраницаМонтажники.Видимость   		= Ложь; //070521
	...
	Если Объект.ВидРабот = Перечисления.ВидыРабот.Монтаж Тогда //5 
		...
		Элементы.ДатаИВремяСборки.Видимость 	= Ложь;
		Элементы.СтраницаМонтажники.Видимость   = Истина;//070521
