...
//		ИначеЕсли ВидРабот = Перечисления.ВидыРабот.Накатка Тогда 
// 			Объект.ТарифЦеха = ОбщегоНазначенияВызовСервера.ПолучитьТарифЦеха(Перечисления.ВидыРабот.Накатка);		
//		ИначеЕсли ВидРабот = Перечисления.ВидыРабот.Резка Тогда 
//			Объект.ТарифЦеха = 30;	
//		ИначеЕсли ВидРабот = Перечисления.ВидыРабот.Ламинация Тогда 
//			Объект.ТарифЦеха = 10;		
		КонецЕсли;
	КонецЕсли;
